...
D[N] => 정수 N을 1, 2, 3의 합으로 나타낼 수 있는 경우의 수 (단 같은 수 연속 X)
...
if N = 3,
D[N] = [
        D[N-1][2] + D[N-1][3],  // 마지막에 사용한 수가 1인 경우의 수
        D[N-2][1] + D[N-2][3],  // 마지막에 사용한 수가 2인 경우의 수
        D[N-3][1] + D[N-3][2]  // 마지막에 사용한 수가 3인 경우의 수
]
"""
